import{f as l,I as j,T as b,t as k,k as a,q as o,v as S,y as h,x as y,g as B,O as w,Y as C}from"../chunks/D9T0Lf-Y.js";import{E as H}from"../chunks/lj3qlEon.js";import{S as T,P as g}from"../chunks/BpD8TiZb.js";import{B as q}from"../chunks/CV_MOeO9.js";const O=!0,R=Object.freeze(Object.defineProperty({__proto__:null,prerender:O},Symbol.toStringTag,{value:"Module"}));var E=l("<span>1</span>"),M=l("<span>2</span>"),z=l("<span>3</span>"),A=l("<!> <!> <!>",1),I=l("<!> <!>",1);function L(c){function p(){S(n,!h(n))}let n=y(!0);var m=I(),v=j(m);q(v,{$$events:{click:p},children:(r,_)=>{w();var t=b();k(()=>C(t,h(n)?"Hide":"Show")),a(r,t)},$$slots:{default:!0}});var d=o(v,2);T(d,{style:"height: 400px",children:(r,_)=>{var t=A(),u=j(t);g(u,{children:(s,i)=>{var e=E();a(s,e)},$$slots:{default:!0}});var f=o(u,2);{var $=s=>{g(s,{children:(i,e)=>{var x=M();a(i,x)},$$slots:{default:!0}})};B(f,s=>{h(n)&&s($)})}var P=o(f,2);g(P,{children:(s,i)=>{var e=z();a(s,e)},$$slots:{default:!0}}),a(r,t)},$$slots:{default:!0}}),a(c,m)}const Y=`<script>
...
`,F={code:Y,highlightedHTML:D,component:L};var G=l("<h2>Toggle a pane on/off</h2> <!>",1);function U(c){var p=G(),n=o(j(p),2);H(n,{get example(){return F}}),a(c,p)}export{U as component,R as universal};
