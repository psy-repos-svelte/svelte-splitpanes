import{m as p,f as g,b as n,u as l,v as u,C as d}from"../chunks/CU39Wntf.js";import{E as f}from"../chunks/BGd-2vSE.js";import{S as v,P as o}from"../chunks/Bd8K-_AF.js";const x=!0,E=Object.freeze(Object.defineProperty({__proto__:null,prerender:x},Symbol.toStringTag,{value:"Module"}));var P=p('<span>1 <br/> <em class="specs">I have a min height of 20% &amp; max height of 70%</em></span>'),b=p("<span>2</span>"),S=p('<span>3 <br/> <em class="specs">I have a max height of 70%</em></span>'),_=p("<!> <!> <!>",1);function $(r){v(r,{horizontal:!0,style:"height: 400px",children:(t,e)=>{var h=_(),c=g(h);o(c,{minSize:20,maxSize:70,children:(s,m)=>{var a=P();n(s,a)},$$slots:{default:!0}});var i=l(c,2);o(i,{children:(s,m)=>{var a=b();n(s,a)},$$slots:{default:!0}});var j=l(i,2);o(j,{maxSize:70,children:(s,m)=>{var a=S();n(s,a)},$$slots:{default:!0}}),n(t,h)},$$slots:{default:!0}})}const z=`<script>
...
`,I={code:z,highlightedHTML:y,component:$};var k=p("<h2>Horizontal layout, push other panes, min & max use, doubleclick</h2> <p>You can double click a splitter to maximize the next pane! <br/> </p> <!>",1);function H(r){var t=k(),e=l(g(t),2),h=l(u(e),2);h.nodeValue=` If you want to disable the 'double click splitter to maximize' behavior, you can add this attribute:
  dblClickSplitter=false.`,d(e);var c=l(e,2);f(c,{get example(){return I}}),n(r,t)}export{H as component,E as universal};
