import{f as l,J as j,S as b,t as k,k as a,q as o,B as S,v as h,C as y,g as B,N as w,W as C}from"../chunks/BOsQt04f.js";import{E as H}from"../chunks/BubSdabz.js";import{S as q,P as g}from"../chunks/BtptOn2B.js";import{B as T}from"../chunks/DKaJlSuI.js";const E=!0,R=Object.freeze(Object.defineProperty({__proto__:null,prerender:E},Symbol.toStringTag,{value:"Module"}));var M=l("<span>1</span>"),O=l("<span>2</span>"),z=l("<span>3</span>"),A=l("<!> <!> <!>",1),J=l("<!> <!>",1);function L(c){function p(){S(n,!h(n))}let n=y(!0);var m=J(),v=j(m);T(v,{$$events:{click:p},children:(r,_)=>{w();var t=b();k(()=>C(t,h(n)?"Hide":"Show")),a(r,t)},$$slots:{default:!0}});var d=o(v,2);q(d,{style:"height: 400px",children:(r,_)=>{var t=A(),u=j(t);g(u,{children:(s,i)=>{var e=M();a(s,e)},$$slots:{default:!0}});var f=o(u,2);{var $=s=>{g(s,{children:(i,e)=>{var x=O();a(i,x)},$$slots:{default:!0}})};B(f,s=>{h(n)&&s($)})}var P=o(f,2);g(P,{children:(s,i)=>{var e=z();a(s,e)},$$slots:{default:!0}}),a(r,t)},$$slots:{default:!0}}),a(c,m)}const N=`<script>
...
`,D={code:N,highlightedHTML:W,component:L};var F=l("<h2>Toggle a pane on/off</h2> <!>",1);function U(c){var p=F(),n=o(j(p),2);H(n,{get example(){return D}}),a(c,p)}export{U as component,R as universal};
