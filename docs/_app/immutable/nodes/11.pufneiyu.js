...
`,k={code:b,highlightedHTML:y,component:$};var z=c("<h2>Lots of splitters & push other panes - all panes have a min width of 5%</h2> <!>",1);function L(a){var s=z(),t=d(n(s),2);_(t,{get example(){return k}}),p(a,s)}export{L as component,E as universal};
