...
`,x={code:b,highlightedHTML:S,component:z};var k=l(`<h2>Disable double click</h2> <p>By default, double clicking the splitter will expand its nearest pane. In this example, we
  demonstrate how to turn this feature OFF</p> <!>`,1);function O(t){var p=k(),c=r(j(p),4);d(c,{get example(){return x}}),n(t,p)}export{O as component,N as universal};
