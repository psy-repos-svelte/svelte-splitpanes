import{p as A,e as f,l as x,k as P,m as u,u as w,v as M,t as R,a9 as E,b as c,d as L,B as v,y as h,z as y,C as S,aa as O,F as q,A as d,Z as H,f as _,c as C,X as J,Y as N}from"../chunks/CU39Wntf.js";import{E as B}from"../chunks/BGd-2vSE.js";import{S as F,P as X}from"../chunks/Bd8K-_AF.js";const Y=!0,ts=Object.freeze(Object.defineProperty({__proto__:null,prerender:Y},Symbol.toStringTag,{value:"Module"}));var Z=u('<div class="container svelte-1taaexb"><pre aria-hidden="true" class="svelte-1taaexb"> </pre> <textarea readonly="" style="outline: none;" class="svelte-1taaexb"></textarea></div>');function D(l,s){A(s,!1);const n=y(),p=y();let e=f(s,"value",12,""),g=f(s,"minRows",8,1),a=f(s,"maxRows",8,40);const z=r=>r.split(/\r?\n/);function m(r,k){const o=z(r);return o.length=k,o.reduce(function($,T){return $+`
`+T})}x(()=>(v(e()),v(a())),()=>{e(m(e(),a()))}),x(()=>v(g()),()=>{h(n,`${1+g()*1.2}em`)}),x(()=>v(a()),()=>{h(p,a()?`${1+a()*1.2}em`:"auto")}),P();var i=Z(),t=M(i),b=M(t,!0);S(t);var j=w(t,2);O(j),S(i),R(()=>{q(t,`min-height: ${d(n)??""}; max-height: ${d(p)??""}`),H(b,e()+`
`)}),E(j,e),c(l,i),L()}var G=u("<span></span>"),I=u("<!> <p>Try resizing panes and check the logs bellow.</p> <!>",1);function K(l){let s=y("// Event name: Event params   (Last event at the top)");function n(a){a.detail?h(s,a.type+" "+JSON.stringify(a.detail)+`
`+d(s)):h(s,a.type+`
`+d(s))}var p=I(),e=_(p);F(e,{style:"height: 400px",$$events:{ready:n,resize:n,resized:n,"pane-click":n,"pane-maximize":n,"pane-add":n,"pane-remove":n,"splitter-click":n},children:(a,z)=>{var m=C(),i=_(m);J(i,0,()=>({length:3}),N,(t,b,j)=>{X(t,{minSize:10,children:(r,k)=>{var o=G();o.textContent=j+1,c(r,o)},$$slots:{default:!0}})}),c(a,m)},$$slots:{default:!0}});var g=w(e,4);D(g,{minRows:4,maxRows:40,get value(){return d(s)},set value(a){h(s,a)},$$legacy:!0}),c(l,p)}const Q=`<script lang="ts">
...
`,V={code:Q,highlightedHTML:U,component:K};var W=u(`<h2>Listening to emitted events</h2> <p>Here is the list of events that are emitted from splitpanes:</p> <ul><li>ready has no parameter and fires when splitpanes is ready</li> <li>resize fires while resizing (on mousemove/touchmove) and returns an array of all the panes
    ...
    splitter. This event is only emitted if dragging did not occur between mousedown and mouseup.</li></ul> <!>`,1);function ls(l){var s=W(),n=w(_(s),6);B(n,{get example(){return V}}),c(l,s)}export{ls as component,ts as universal};
