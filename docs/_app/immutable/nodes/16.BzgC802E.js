import{m as a,f as h,b as s,u as t}from"../chunks/CU39Wntf.js";import{E as x}from"../chunks/BGd-2vSE.js";import{S,P as p}from"../chunks/Bd8K-_AF.js";const $=!0,I=Object.freeze(Object.defineProperty({__proto__:null,prerender:$},Symbol.toStringTag,{value:"Module"}));var y=a("<p>MenuBar - This is a splitpane, note how the splitters made static using CSS</p>"),k=a("<p>ToolBar - This is another fixed size, locked splitpane</p>"),w=a("<p>Folder <br/> You can move those --&gt;</p>"),T=a("<p>Sample content</p>"),q=a("<p>Details <br/> &lt;-- You can move those</p>"),C=a("<!> <!> <!>",1),B=a("<p>statusbar - and yet, another splitpane, same technique</p>"),M=a("<!> <!> <!> <!>",1);function Y(o){S(o,{theme:"no-splitter",horizontal:!0,style:"height: 400px",dblClickSplitter:!1,children:(c,j)=>{var m=M(),g=h(m);p(g,{size:6,minSize:6,maxSize:6,children:(n,i)=>{var l=y();s(n,l)},$$slots:{default:!0}});var u=t(g,2);p(u,{size:6,minSize:6,maxSize:6,children:(n,i)=>{var l=k();s(n,l)},$$slots:{default:!0}});var b=t(u,2);p(b,{children:(n,i)=>{S(n,{theme:"modern-theme",children:(l,A)=>{var d=C(),_=h(d);p(_,{children:(e,v)=>{var r=w();s(e,r)},$$slots:{default:!0}});var f=t(_,2);p(f,{children:(e,v)=>{var r=T();s(e,r)},$$slots:{default:!0}});var P=t(f,2);p(P,{children:(e,v)=>{var r=q();s(e,r)},$$slots:{default:!0}}),s(l,d)},$$slots:{default:!0}})},$$slots:{default:!0}});var z=t(b,2);p(z,{size:6,minSize:6,maxSize:6,children:(n,i)=>{var l=B();s(n,l)},$$slots:{default:!0}}),s(c,m)},$$slots:{default:!0}})}const F=`<script>
...
`,E={code:F,highlightedHTML:D,component:Y};var O=a(`<h2>Styling Splitters - Modern</h2> <p>This examples uses CSS styles to pixel size panes and lock them in place. applied to panes in
  order to achieve the desired layout.</p> <!>`,1);function J(o){var c=O(),j=t(h(c),4);x(j,{get example(){return E}}),s(o,c)}export{J as component,I as universal};
