import{f as l,J as f,k as n,q as o,N as e}from"../chunks/BOsQt04f.js";import{E as u}from"../chunks/BubSdabz.js";import{S as d,P as r}from"../chunks/BtptOn2B.js";const v=!0,E=Object.freeze(Object.defineProperty({__proto__:null,prerender:v},Symbol.toStringTag,{value:"Module"}));var z=l("<span>1</span> <p>Default size of 65%</p>",1),P=l("<span>2</span> <p>Default size of 10%</p>",1),_=l("<span>3</span> <p>Default size of 25%</p>",1),$=l("<!> <!> <!>",1);function y(t){d(t,{horizontal:!0,style:"height: 400px",children:(p,h)=>{var i=$(),c=f(i);r(c,{size:65,children:(s,j)=>{var a=z();e(2),n(s,a)},$$slots:{default:!0}});var g=o(c,2);r(g,{size:10,children:(s,j)=>{var a=P();e(2),n(s,a)},$$slots:{default:!0}});var m=o(g,2);r(m,{size:25,children:(s,j)=>{var a=_();e(2),n(s,a)},$$slots:{default:!0}}),n(p,i)},$$slots:{default:!0}})}const x=`<script>
...
`,S={code:x,highlightedHTML:D,component:y};var b=l(`<h2>Default pane size</h2> <p>Provide dimension of your panes when they first load (will be used for the width or height
  respectively for the vertical or horizontal layout). <br/> <b>If you provide a default size, make sure you provide it for all the panes for a total equals to
    100%. If a pane is missing a default size, then all the panes will have the same size.</b> <br/> Note that setting a default value is different than setting a min or max value.</p> <!>`,1);function I(t){var p=b(),h=o(f(p),4);u(h,{get example(){return S}}),n(t,p)}export{I as component,E as universal};
