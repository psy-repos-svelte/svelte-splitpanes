...
`,k={code:z,highlightedHTML:y,component:$};var q=p("<h2>Horizontal layout, push other panes, min & max use, doubleclick</h2> <p>You can double click a splitter to maximize the next pane! <br/> </p> <!>",1);function H(r){var t=q(),e=l(g(t),2),h=l(u(e),2);h.nodeValue=` If you want to disable the 'double click splitter to maximize' behavior, you can add this attribute:
  dblClickSplitter=false.`,d(e);var c=l(e,2);f(c,{get example(){return k}}),n(r,t)}export{H as component,C as universal};
