...
<span class="hljs-selector-class">.default-theme</span> <span class="hljs-selector-class">.splitpanes--horizontal</span> &gt; <span class="hljs-selector-class">.splitpanes__splitter</span><span class="hljs-selector-pseudo">:after</span> {
  <span class="hljs-attribute">margin-top</span>: <span class="hljs-number">1px</span>;
}`,X={code:ns,highlightedHTML:es,css:ls,cssHighlightedHTML:ps};function rs(i){let s,p="Styling Splitters",t,l,e="Styling splitters is fully customizable using CSS (or SCSS), the `theme` property is used to select the proper styling\n	class and apply it to the Splitpanes component.<br/>\n	The default style is called `default-theme`, its SCSS definition can be found below (<b>warning</b>: This is for\n	reference only! If you decide to copy this CSS code, you must rename the &quot;.default-theme&quot; specifier to something else,\n	so it wouldn&#39;t conflict the library theme CSS definition):",c,n,r,j,C="Alternatively, here is the default theme compiled to CSS:",S,y,T,k,A='By altering the above styles, it is possible to achieve neat visual adjustments. Please note how each Splitpanes\n	references our new `theme="my-theme"`',M,P,L;return n=new I({props:{lang:"scss",highlighted:X.highlightedHTML}}),y=new I({props:{lang:"scss",highlighted:X.cssHighlightedHTML}}),P=new B({props:{example:as}}),{c(){s=v("h2"),s.textContent=p,t=$(),l=v("p"),l.innerHTML=e,c=$(),m(n.$$.fragment),r=$(),j=v("p"),j.textContent=C,S=$(),m(y.$$.fragment),T=$(),k=v("p"),k.textContent=A,M=$(),m(P.$$.fragment)},l(a){s=z(a,"H2",{["data-svelte-h"]:!0}),w(s)!=="svelte-1miri38"&&(s.textContent=p),t=x(a),l=z(a,"P",{["data-svelte-h"]:!0}),w(l)!=="svelte-1af2sqc"&&(l.innerHTML=e),c=x(a),f(n.$$.fragment,a),r=x(a),j=z(a,"P",{["data-svelte-h"]:!0}),w(j)!=="svelte-1geu27k"&&(j.textContent=C),S=x(a),f(y.$$.fragment,a),T=x(a),k=z(a,"P",{["data-svelte-h"]:!0}),w(k)!=="svelte-7m77bz"&&(k.textContent=A),M=x(a),f(P.$$.fragment,a)},m(a,u){o(a,s,u),o(a,t,u),o(a,l,u),o(a,c,u),b(n,a,u),o(a,r,u),o(a,j,u),o(a,S,u),b(y,a,u),o(a,T,u),o(a,k,u),o(a,M,u),b(P,a,u),L=!0},p:H,i(a){L||(g(n.$$.fragment,a),g(y.$$.fragment,a),g(P.$$.fragment,a),L=!0)},o(a){_(n.$$.fragment,a),_(y.$$.fragment,a),_(P.$$.fragment,a),L=!1},d(a){a&&(h(s),h(t),h(l),h(c),h(r),h(j),h(S),h(T),h(k),h(M)),d(n,a),d(y,a),d(P,a)}}}class us extends Y{constructor(s){super(),E(this,s,null,rs,N,{})}}export{us as component,hs as universal};
