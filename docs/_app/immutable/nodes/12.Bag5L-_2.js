import{f as c,I as o,T as $,k as t,y as a,_ as m,q as g,x as S,H as y,W as P,N as B,r as k,A as b,t as w,D as z,Y as q,X as T}from"../chunks/BRgjEU4t.js";import{E as A}from"../chunks/CHq8T5Ic.js";import{S as E,P as H}from"../chunks/npSn8GHY.js";import{B as M}from"../chunks/bqCuc9Yn.js";const O=!0,K=Object.freeze(Object.defineProperty({__proto__:null,prerender:O},Symbol.toStringTag,{value:"Module"}));var C=c("<span> </span>"),D=c("<!> <!>",1);function I(r){const s=S([{color:"red"},{color:"blue"}]);var l=D(),h=o(l);M(h,{$$events:{click:()=>{const n=a(s)[0];m(s,a(s)[0]=a(s)[1]),m(s,a(s)[1]=n)}},children:(n,u)=>{B();var e=$("Switch");t(n,e)},$$slots:{default:!0}});var j=g(h,2);E(j,{style:"height: 400px",children:(n,u)=>{var e=y(),v=o(e);P(v,1,()=>a(s),T,(f,i)=>{H(f,{minSize:10,children:(x,X)=>{var p=C();let d;var _=k(p,!0);b(p),w(()=>{d=z(p,"",d,{color:a(i).color}),q(_,a(i).color)}),t(x,p)},$$slots:{default:!0}})}),t(n,e)},$$slots:{default:!0}}),t(r,l)}const L=`<script>
